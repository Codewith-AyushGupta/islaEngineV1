...
${WHERE_condition_startingwithAND}
${GroupBY_includeTheWordGROUPBY_IfNUll_PutEmtpyString};
...
SELECT 
orders.orderTimeZoneCreatedAtDate AS date,
...
LEFT JOIN storeheroAggregations aggregations ON orders.orderId = aggregations.groupBy;




COPY (SELECT * FROM outputTableForCSV ) TO '${s3BucketRoot}/tenants/tenantid=${tenantId}/transposed-output/tablename=export-output/${queryname}_${uuid}.csv.gz'
